...
var Task = module.exports = aei.ImportObject.extend().performSets({
	...
	assignToUser: function(assigneeAsanaId) {
		return aei.Future.withPromise(this._resource().update(this.asanaId(), { assignee: assigneeAsanaId }));
	},

	addFollowers: function(followerAsanaIds) {
		return aei.Future.withPromise(this._resource().addFollowers(this.asanaId(), { followers: followerAsanaIds }));
	},
