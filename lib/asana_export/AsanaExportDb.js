...
var ImporterDb = module.exports = ae.ideal.Proto.extend().newSlots({
	...
	findByTypeLike: function(type, offset, limit) {
		return this.findByTypesLike([type], offset, limit);
	},
	...
	findByTypesLike: function(types, offset, limit) {
		...
		/*
		if (types.contains("Team")) { sql += " AND sourceId = 9275767906681"; } //TODO
		if (types.contains("ItemList")) { sql += " AND sourceId = 15083303022168"; } //TODO
		if (types.contains("Task")) { sql += " AND sourceId IN(15083303022180, 15700786454609)"; } //TODO
